...
public static class BalloonShopConfiguration
{
  ...
  static BalloonShopConfiguration()
  {
    ...
    dbConnectionString = ConfigurationManager.ConnectionStrings["BalloonShopConnectionString"].ConnectionString;
    dbProviderName = ConfigurationManager.ConnectionStrings["BalloonShopConnectionString"].ProviderName;
