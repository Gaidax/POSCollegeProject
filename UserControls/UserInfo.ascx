...
<table cellspacing="0" border="0" width="200px" class="UserInfoContent">
  ...
  <asp:LoginView ID="LoginView1" runat="server">
    <AnonymousTemplate>
      <tr>
        <td>
          <asp:Label ID ="userLabel" runat="server" Text="Logged in as"></asp:Label>
        </td>
      </tr>
      <tr>
        <td>
            &nbsp;»<asp:Button ID="LoginButton" OnClick="Logout" runat="server" Height="23px" Text="Login" Width="47px" />
            «
        </td>
      </tr>
    </AnonymousTemplate>
